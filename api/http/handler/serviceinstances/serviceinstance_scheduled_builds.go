...
// @id ServiceInstanceScheduledBuilds
// @summary List scheduled builds for a service instance
// @description Returns all scheduled builds for the given service instance.
// @description **Access policy**: authenticated
// @tags service_instances
// @security ApiKeyAuth
// @security jwt
// @param id path int true "Service instance identifier"
// @success 200 {array} portainer.ServiceInstanceScheduledBuild "Success"
// @failure 400 "Invalid request"
// @failure 404 "Service instance not found"
// @failure 500 "Server error"
// @router /service-instances/{id}/scheduled-builds [get]
func (handler *Handler) serviceInstanceScheduledBuilds(w http.ResponseWriter, r *http.Request) *httperror.HandlerError {
	...
	builds, err := handler.Service.ListScheduledBuilds(instance.ID)
	if err != nil {
		return httperror.InternalServerError("Unable to retrieve scheduled builds", err)
	}

	return response.JSON(w, builds)
}
